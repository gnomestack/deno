...
export function yes(args: string[] | Record<string, unknown>, options?: IExecOptions) {
...
export function yesSync(args: string[] | Record<string, unknown>, options?: IExecSyncOptions) {
    if (Array.isArray(args)) {
