...
export function mktemp(args: string[] | Record<string, unknown>, options?: IExecOptions) {
...
export function mktempSync(args: string[] | Record<string, unknown>, options?: IExecSyncOptions) {
    if (Array.isArray(args)) {
