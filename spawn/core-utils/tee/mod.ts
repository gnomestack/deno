...
export function tee(args: string[] | Record<string, unknown>, options?: IExecOptions) {
...
export function teeSync(args: string[] | Record<string, unknown>, options?: IExecSyncOptions) {
    if (Array.isArray(args)) {
