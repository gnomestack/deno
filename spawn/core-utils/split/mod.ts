...
export function split(args: string[] | Record<string, unknown>, options?: IExecOptions) {
...
export function splitSync(args: string[] | Record<string, unknown>, options?: IExecSyncOptions) {
    if (Array.isArray(args)) {
