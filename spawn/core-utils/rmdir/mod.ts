...
export function rmdir(args: string[] | Record<string, unknown>, options?: IExecOptions) {
...
export function rmdirSync(args: string[] | Record<string, unknown>, options?: IExecSyncOptions) {
    if (Array.isArray(args)) {
