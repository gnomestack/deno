...
export function realpath(args: string[] | Record<string, unknown>, options?: IExecOptions) {
...
export function realpathSync(args: string[] | Record<string, unknown>, options?: IExecSyncOptions) {
    if (Array.isArray(args)) {
