...
export function dirname(args: string[] | Record<string, unknown>, options?: IExecOptions) {
...
export function dirnameSync(args: string[] | Record<string, unknown>, options?: IExecSyncOptions) {
    if (Array.isArray(args)) {
