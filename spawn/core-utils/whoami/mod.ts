...
export function whoami(args: string[] | Record<string, unknown>, options?: IExecOptions) {
...
export function whoamiSync(args: string[] | Record<string, unknown>, options?: IExecSyncOptions) {
    if (Array.isArray(args)) {
