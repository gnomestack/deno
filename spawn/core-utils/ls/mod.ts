...
export function ls(args: string[] | Record<string, unknown>, options?: IExecOptions) {
...
export function lsSync(args: string[] | Record<string, unknown>, options?: IExecSyncOptions) {
    if (Array.isArray(args)) {
