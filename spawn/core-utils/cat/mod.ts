...
export function cat(args: string[] | Record<string, unknown>, options?: IExecOptions) {
...
export function catSync(args: string[] | Record<string, unknown>, options?: IExecSyncOptions) {
    if (Array.isArray(args)) {
