...
export function printenv(args: string[] | Record<string, unknown>, options?: IExecOptions) {
...
export function printenvSync(args: string[] | Record<string, unknown>, options?: IExecSyncOptions) {
    if (Array.isArray(args)) {
