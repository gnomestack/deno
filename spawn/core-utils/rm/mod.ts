...
export function rm(args: string[] | Record<string, unknown>, options?: IExecOptions) {
...
export function rmSync(args: string[] | Record<string, unknown>, options?: IExecSyncOptions) {
    if (Array.isArray(args)) {
