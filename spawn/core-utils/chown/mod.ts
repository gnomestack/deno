...
export function chown(args: string[] | Record<string, unknown>, options?: IExecOptions) {
...
export function chownSync(args: string[] | Record<string, unknown>, options?: IExecSyncOptions) {
    if (Array.isArray(args)) {
