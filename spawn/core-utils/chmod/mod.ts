...
export function chmod(args: string[] | Record<string, unknown>, options?: IExecOptions) {
...
export function chmodSync(args: string[] | Record<string, unknown>, options?: IExecSyncOptions) {
    if (Array.isArray(args)) {
