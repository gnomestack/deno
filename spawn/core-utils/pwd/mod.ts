...
export function pwd(args: string[] | Record<string, unknown>, options?: IExecOptions) {
...
export function pwdSync(args: string[] | Record<string, unknown>, options?: IExecSyncOptions) {
    if (Array.isArray(args)) {
