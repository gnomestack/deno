...
export function ln(args: string[] | Record<string, unknown>, options?: IExecOptions) {
...
export function lnSync(args: string[] | Record<string, unknown>, options?: IExecSyncOptions) {
    if (Array.isArray(args)) {
