...
export function mv(args: string[] | Record<string, unknown>, options?: IExecOptions) {
...
export function mvSync(args: string[] | Record<string, unknown>, options?: IExecSyncOptions) {
    if (Array.isArray(args)) {
