...
export function cksum(args: string[] | Record<string, unknown>, options?: IExecOptions) {
...
export function cksumSync(args: string[] | Record<string, unknown>, options?: IExecSyncOptions) {
    if (Array.isArray(args)) {
