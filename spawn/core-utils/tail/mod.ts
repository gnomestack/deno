...
export function tail(args: string[] | Record<string, unknown>, options?: IExecOptions) {
...
export function tailSync(args: string[] | Record<string, unknown>, options?: IExecSyncOptions) {
    if (Array.isArray(args)) {
