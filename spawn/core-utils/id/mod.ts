...
export function id(args: string[] | Record<string, unknown>, options?: IExecOptions) {
...
export function idSync(args: string[] | Record<string, unknown>, options?: IExecSyncOptions) {
    if (Array.isArray(args)) {
