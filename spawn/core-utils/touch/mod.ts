...
export function touch(args: string[] | Record<string, unknown>, options?: IExecOptions) {
...
export function touchSync(args: string[] | Record<string, unknown>, options?: IExecSyncOptions) {
    if (Array.isArray(args)) {
