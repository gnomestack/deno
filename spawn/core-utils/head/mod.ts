...
export function head(args: string[] | Record<string, unknown>, options?: IExecOptions) {
...
export function headSync(args: string[] | Record<string, unknown>, options?: IExecSyncOptions) {
    if (Array.isArray(args)) {
