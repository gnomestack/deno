...
export function paste(args: string[] | Record<string, unknown>, options?: IExecOptions) {
...
export function pasteSync(args: string[] | Record<string, unknown>, options?: IExecSyncOptions) {
    if (Array.isArray(args)) {
