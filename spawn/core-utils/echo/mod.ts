...
export function echo(args: string[] | Record<string, unknown>, options?: IExecOptions) {
...
export function echoSync(args: string[] | Record<string, unknown>, options?: IExecSyncOptions) {
    if (Array.isArray(args)) {
