...
export function cut(args: string[] | Record<string, unknown>, options?: IExecOptions) {
...
export function cutSync(args: string[] | Record<string, unknown>, options?: IExecSyncOptions) {
    if (Array.isArray(args)) {
