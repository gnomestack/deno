...
export function du(args: string[] | Record<string, unknown>, options?: IExecOptions) {
...
export function duSync(args: string[] | Record<string, unknown>, options?: IExecSyncOptions) {
    if (Array.isArray(args)) {
