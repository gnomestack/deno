...
export function basename(args: string[] | Record<string, unknown>, options?: IExecOptions) {
...
export function basenameSync(args: string[] | Record<string, unknown>, options?: IExecSyncOptions) {
    if (Array.isArray(args)) {
