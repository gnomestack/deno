...
export function env(args: string[] | Record<string, unknown>, options?: IExecOptions) {
...
export function envSync(args: string[] | Record<string, unknown>, options?: IExecSyncOptions) {
    if (Array.isArray(args)) {
