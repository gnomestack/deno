...
export function mkdir(args: string[] | Record<string, unknown>, options?: IExecOptions) {
...
export function mkdirSync(args: string[] | Record<string, unknown>, options?: IExecSyncOptions) {
    if (Array.isArray(args)) {
