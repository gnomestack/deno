...
export function scoop(args: string[] | Record<string, unknown>, options?: IExecOptions) {
...
export function scoopSync(args: string[] | Record<string, unknown>, options?: IExecSyncOptions) {
    if (Array.isArray(args)) {
