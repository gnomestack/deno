...
export function netsh(args: string[] | Record<string, unknown>, options?: IExecOptions) {
...
export function netshSync(args: string[] | Record<string, unknown>, options?: IExecSyncOptions) {
    if (Array.isArray(args)) {
