...
export function wsl(args: string[] | Record<string, unknown>, options?: IExecOptions) {
...
export function wslSync(args: string[] | Record<string, unknown>, options?: IExecSyncOptions) {
    if (Array.isArray(args)) {
