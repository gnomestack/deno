...
export function winget(args: string[] | Record<string, unknown>, options?: IExecOptions) {
...
export function wingetSync(args: string[] | Record<string, unknown>, options?: IExecSyncOptions) {
    if (Array.isArray(args)) {
