...
export function dism(args: string[] | Record<string, unknown>, options?: IExecOptions) {
...
export function dismSync(args: string[] | Record<string, unknown>, options?: IExecSyncOptions) {
    if (Array.isArray(args)) {
