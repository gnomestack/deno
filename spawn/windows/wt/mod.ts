...
export function wt(args: string[] | Record<string, unknown>, options?: IExecOptions) {
...
export function wtSync(args: string[] | Record<string, unknown>, options?: IExecSyncOptions) {
    if (Array.isArray(args)) {
