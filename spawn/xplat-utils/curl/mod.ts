...
export function curl(args: string[] | Record<string, unknown>, options?: IExecOptions) {
...
export function curlSync(args: string[] | Record<string, unknown>, options?: IExecSyncOptions) {
    if (Array.isArray(args)) {
