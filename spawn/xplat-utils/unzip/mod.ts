...
export function unzip(args: string[] | Record<string, unknown>, options?: IExecOptions) {
...
export function unzipSync(args: string[] | Record<string, unknown>, options?: IExecSyncOptions) {
    if (Array.isArray(args)) {
