...
export function scp(args: string[] | Record<string, unknown>, options?: IExecOptions) {
...
export function scpSync(args: string[] | Record<string, unknown>, options?: IExecSyncOptions) {
    if (Array.isArray(args)) {
