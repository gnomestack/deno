...
export function ssh(args: string[] | Record<string, unknown>, options?: IExecOptions) {
...
export function sshSync(args: string[] | Record<string, unknown>, options?: IExecSyncOptions) {
    if (Array.isArray(args)) {
