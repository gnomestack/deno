...
export function sftp(args: string[] | Record<string, unknown>, options?: IExecOptions) {
...
export function sftpSync(args: string[] | Record<string, unknown>, options?: IExecSyncOptions) {
    if (Array.isArray(args)) {
