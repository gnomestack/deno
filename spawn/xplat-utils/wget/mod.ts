...
export function wget(args: string[] | Record<string, unknown>, options?: IExecOptions) {
...
export function wgetSync(args: string[] | Record<string, unknown>, options?: IExecSyncOptions) {
    if (Array.isArray(args)) {
