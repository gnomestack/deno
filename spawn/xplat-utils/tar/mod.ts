...
export function tar(args: string[] | Record<string, unknown>, options?: IExecOptions) {
...
export function tarSync(args: string[] | Record<string, unknown>, options?: IExecSyncOptions) {
    if (Array.isArray(args)) {
