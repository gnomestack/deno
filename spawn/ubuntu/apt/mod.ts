...
export function apt(args: string[] | Record<string, unknown>, options?: IExecOptions) {
...
export function aptSync(args: string[] | Record<string, unknown>, options?: IExecSyncOptions) {
    if (Array.isArray(args)) {
