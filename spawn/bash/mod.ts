...
export function bash(args: string[] | Record<string, unknown>, options?: IExecOptions) {
...
export function bashSync(args: string[] | Record<string, unknown>, options?: IExecSyncOptions) {
    if (Array.isArray(args)) {
