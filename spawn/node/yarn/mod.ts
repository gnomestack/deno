...
export function yarn(args: string[] | Record<string, unknown>, options?: IExecOptions) {
...
export function yarnSync(args: string[] | Record<string, unknown>, options?: IExecSyncOptions) {
    if (Array.isArray(args)) {
