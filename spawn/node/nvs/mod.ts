...
export function nvs(args: string[] | Record<string, unknown>, options?: IExecOptions) {
...
export function nvsSync(args: string[] | Record<string, unknown>, options?: IExecSyncOptions) {
    if (Array.isArray(args)) {
