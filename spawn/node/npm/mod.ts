...
export function npm(args: string[] | Record<string, unknown>, options?: IExecOptions) {
...
export function npmSync(args: string[] | Record<string, unknown>, options?: IExecSyncOptions) {
    if (Array.isArray(args)) {
