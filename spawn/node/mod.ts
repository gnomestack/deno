...
export function node(args: string[] | Record<string, unknown>, options?: IExecOptions) {
...
export function nodeSync(args: string[] | Record<string, unknown>, options?: IExecSyncOptions) {
    if (Array.isArray(args)) {
