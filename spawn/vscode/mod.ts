...
export function vscode(args: string[] | Record<string, unknown>, options?: IExecOptions) {
...
export function vscodeSync(args: string[] | Record<string, unknown>, options?: IExecSyncOptions) {
    if (Array.isArray(args)) {
