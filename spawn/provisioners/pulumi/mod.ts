...
export function pulumi(args: string[] | Record<string, unknown>, options?: IExecOptions) {
...
export function pulumiSync(args: string[] | Record<string, unknown>, options?: IExecSyncOptions) {
    if (Array.isArray(args)) {
