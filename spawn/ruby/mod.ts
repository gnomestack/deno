...
export function ruby(args: string[] | Record<string, unknown>, options?: IExecOptions) {
...
export function rubySync(args: string[] | Record<string, unknown>, options?: IExecSyncOptions) {
    if (Array.isArray(args)) {
