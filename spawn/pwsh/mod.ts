...
export function pwsh(args: string[] | Record<string, unknown>, options?: IExecOptions) {
...
export function pwshSync(args: string[] | Record<string, unknown>, options?: IExecSyncOptions) {
    if (Array.isArray(args)) {
