...
export function bun(args: string[] | Record<string, unknown>, options?: IExecOptions) {
...
export function bunSync(args: string[] | Record<string, unknown>, options?: IExecSyncOptions) {
    if (Array.isArray(args)) {
