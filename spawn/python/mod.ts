...
export function python(args: string[] | Record<string, unknown>, options?: IExecOptions) {
...
export function pythonSync(args: string[] | Record<string, unknown>, options?: IExecSyncOptions) {
    if (Array.isArray(args)) {
