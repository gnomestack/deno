...
export function powershell(args: string[] | Record<string, unknown>, options?: IExecOptions) {
...
export function powershellSync(args: string[] | Record<string, unknown>, options?: IExecSyncOptions) {
    if (Array.isArray(args)) {
