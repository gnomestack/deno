...
export function deno(args: string[] | Record<string, unknown>, options?: IExecOptions) {
...
export function denoSync(args: string[] | Record<string, unknown>, options?: IExecSyncOptions) {
    if (Array.isArray(args)) {
