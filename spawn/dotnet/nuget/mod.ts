...
export function nuget(args: string[] | Record<string, unknown>, options?: IExecOptions) {
...
export function nugetSync(args: string[] | Record<string, unknown>, options?: IExecSyncOptions) {
    if (Array.isArray(args)) {
